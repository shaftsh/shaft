...
import (
	...
	"github.com/shaft/go-shaft/contracts/ens"
	...
	"github.com/shaft/go-shaft/swarm"
	bzzapi "github.com/shaft/go-shaft/swarm/api"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:  "swap-api",
		Usage: "URL of the SHAFT API provider to use to settle SWAP payments",
	}
	...
	EnsAPIFlag = cli.StringFlag{
		Name:  "ens-api",
		Usage: "URL of the SHAFT API provider to use for ENS record lookups",
...
var app = utils.NewApp(gitCommit, "SHAFT Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2016 The go-shaft Authors"

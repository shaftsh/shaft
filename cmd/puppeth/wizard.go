...
type wizard struct {
	...
	services map[string][]string   // SHAFT services known to be running on servers
...
// converts it to an SHAFT address. If an empty line is entered, the default
// value is returned.

...
// setting up a new or managing an existing SHAFT private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your SHAFT private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new SHAFT network down to  |")
	...
	log.Info("Administering SHAFT network", "name", w.network)

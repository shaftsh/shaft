...
// This file is part of go-shaft.
//
// go-shaft is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// go-shaft is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU General Public License for more details.
//
// You should have received a copy of the GNU General Public License
// along with go-shaft. If not, see <http://www.gnu.org/licenses/>.

// Package utils contains internal helper functions for go-shaft commands.
package utils
...
import (
	...
	"github.com/shaft/go-shaft/core/state"
	...
	"github.com/shaft/go-shaft/metrics"
	"github.com/shaft/go-shaft/node"
	"github.com/shaft/go-shaft/p2p"
	"github.com/shaft/go-shaft/p2p/discover"
	"github.com/shaft/go-shaft/p2p/discv5"
	"github.com/shaft/go-shaft/p2p/nat"
	"github.com/shaft/go-shaft/p2p/netutil"
...
func SetNodeConfig(ctx *cli.Context, cfg *node.Config) {
	...
	case ctx.GlobalBool(DevModeFlag.Name):
		cfg.DataDir = filepath.Join(os.TempDir(), "shaft_dev_mode")
	case ctx.GlobalBool(TestnetFlag.Name):
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *eth.Config) {
	...
	// SHAFT needs to know maxPeers to calculate the light server peer ratio.
	// TODO(fjl): ensure SHAFT can get MaxPeers from node.
	cfg.MaxPeers = ctx.GlobalInt(MaxPeersFlag.Name)
...
// RegisterEthService adds an SHAFT client to the stack.
func RegisterEthService(stack *node.Node, cfg *eth.Config) {
	...
	if err != nil {
		Fatalf("Failed to register the SHAFT service: %v", err)
	}
}
...
// RegisterEthStatsService configures the SHAFT Stats daemon and adds it to
// th egiven node.
func RegisterEthStatsService(stack *node.Node, url string) {
	if err := stack.Register(func(ctx *node.ServiceContext) (node.Service, error) {
		// Retrieve both eth and les services
		var ethServ *eth.SHAFT
		ctx.Service(&ethServ)
		...
		Fatalf("Failed to register the SHAFT Stats service: %v", err)
	}
}

...
// Package types contains data types related to SHAFT consensus.
package types
...
// Header represents a block header in the SHAFT blockchain.
type Header struct {
...
// Block represents an entire block in the SHAFT blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the SHAFT RLP block format.

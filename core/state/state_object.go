...
// stateObject represents an SHAFT account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of shaft address of the account
	data     Account
	db       *StateDB
...
// Account is the SHAFT consensus representation of accounts.

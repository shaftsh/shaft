...
// all blocks' seal as valid, though they still have to conform to the SHAFT
// consensus rules.
...
// still have to conform to the SHAFT consensus rules.
...
// they still have to conform to the SHAFT consensus rules.

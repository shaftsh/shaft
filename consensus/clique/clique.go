...
import (
	...
	"github.com/shaft/go-shaft/crypto/sha3"
...
// ecrecover extracts the SHAFT account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the SHAFT address
...
// SHAFT testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // SHAFT address of the signing key
...
// Author implements consensus.Engine, returning the SHAFT address recovered

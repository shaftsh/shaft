...
// Package ethclient provides a client for the SHAFT RPC API.
package ethclient
...
// Client defines typed wrappers for the SHAFT RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, shaft.NotFound
	}
...
func (ec *Client) SyncProgress(ctx context.Context) (*shaft.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (shaft.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q shaft.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q shaft.FilterQuery, ch chan<- types.Log) (shaft.Subscription, error) {
	return ec.c.EthSubscribe(ctx, ch, "logs", toFilterArg(q))
}

func toFilterArg(q shaft.FilterQuery) interface{} {
...
func (ec *Client) CallContract(ctx context.Context, msg shaft.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg shaft.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg shaft.CallMsg) (*big.Int, error) {
	var hex hexutil.Big
...
func toCallArg(msg shaft.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}

...
// Package les implements the Light SHAFT Subprotocol.
package les
...
import (
	...
	"github.com/shaft/go-shaft/light"
	...
	rpc "github.com/shaft/go-shaft/rpc"
)
...
func New(ctx *node.ServiceContext, config *eth.Config) (*LightSHAFT, error) {
...
func (s *LightSHAFT) APIs() []rpc.API {
...
func (s *LightSHAFT) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *LightSHAFT) BlockChain() *light.LightChain      { return s.blockchain }
func (s *LightSHAFT) TxPool() *light.TxPool              { return s.txPool }
func (s *LightSHAFT) Engine() consensus.Engine           { return s.engine }
func (s *LightSHAFT) LesVersion() int                    { return int(s.protocolManager.SubProtocols[0].Version) }
func (s *LightSHAFT) Downloader() *downloader.Downloader { return s.protocolManager.downloader }
func (s *LightSHAFT) EventMux() *event.TypeMux           { return s.eventMux }

// Protocols implements node.Service, returning all the currently configured
// network protocols to start.
func (s *LightSHAFT) Protocols() []p2p.Protocol {
	return s.protocolManager.SubProtocols
}

// Start implements node.Service, starting all internal goroutines needed by the
// SHAFT protocol implementation.
func (s *LightSHAFT) Start(srvr *p2p.Server) error {

...
// ReleaseOracle is an SHAFT contract to store the current and previous
// versions of the go-shaft implementation. Its goal is to allow Geth to
...
contract ReleaseOracle {
  ...
  // updateSigner marks a vote for changing the status of an SHAFT user, either

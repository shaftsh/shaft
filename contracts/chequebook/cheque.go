...
// Package chequebook package wraps the 'chequebook' SHAFT smart contract.
//
...
import (
	...
	"github.com/shaft/go-shaft/contracts/chequebook/contract"
	"github.com/shaft/go-shaft/core/types"
	"github.com/shaft/go-shaft/crypto"
	"github.com/shaft/go-shaft/log"
	"github.com/shaft/go-shaft/swarm/services/swap/swap"
)
...
// Cash cashes the cheque by sending an SHAFT transaction.

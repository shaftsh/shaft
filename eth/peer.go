...
// PeerInfo represents a short summary of the SHAFT sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // SHAFT protocol version negotiated

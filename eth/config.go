...
// DefaultConfig contains default settings for use on the SHAFT main net.
var DefaultConfig = Config{
	SyncMode:             downloader.FastSync,
	EthashCacheDir:       "shafthash",
	EthashCachesInMem:    2,
...
func init() {
	...
	if runtime.GOOS == "windows" {
		DefaultConfig.EthashDatasetDir = filepath.Join(home, "AppData", "Shafthash")
	} else {
		DefaultConfig.EthashDatasetDir = filepath.Join(home, ".shafthash")
	}
}
...
type Config struct {
	...
	// If nil, the SHAFT main net block is used.

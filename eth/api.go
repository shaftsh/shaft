...
import (
	...
	"github.com/shaft/go-shaft/trie"
)

const defaultTraceTimeout = 5 * time.Second

// PublicSHAFTAPI provides an API to access SHAFT full node-related
// information.
type PublicSHAFTAPI struct {
	e *SHAFT
}

// NewPublicSHAFTAPI creates a new Etheruem protocol API for full nodes.
func NewPublicSHAFTAPI(e *SHAFT) *PublicSHAFTAPI {
	return &PublicSHAFTAPI{e}
}

// Etherbase is the address that mining rewards will be send to
func (api *PublicSHAFTAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase)
func (api *PublicSHAFTAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate
func (api *PublicSHAFTAPI) Hashrate() hexutil.Uint64 {
...
func NewPublicMinerAPI(e *SHAFT) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *SHAFT) *PrivateMinerAPI {
...
// admin methods of the SHAFT service.
func NewPrivateAdminAPI(eth *SHAFT) *PrivateAdminAPI {
...
// related public debug methods of the SHAFT service.
func NewPublicDebugAPI(eth *SHAFT) *PublicDebugAPI {
...
// private debug methods of the SHAFT service.
func NewPrivateDebugAPI(config *params.ChainConfig, eth *SHAFT) *PrivateDebugAPI {

...
// Contains a wrapper for the SHAFT client.
...
// SHAFTClient provides access to the SHAFT APIs.
type SHAFTClient struct {
	client *ethclient.Client
}

// NewSHAFTClient connects a client to the given URL.
func NewSHAFTClient(rawurl string) (client *SHAFTClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &SHAFTClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *SHAFTClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *SHAFTClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *SHAFTClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *SHAFTClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *SHAFTClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *SHAFTClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *SHAFTClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *SHAFTClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *SHAFTClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *SHAFTClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *SHAFTClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *SHAFTClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *SHAFTClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *SHAFTClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *SHAFTClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *SHAFTClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *SHAFTClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *SHAFTClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *SHAFTClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *SHAFTClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *SHAFTClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *SHAFTClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *SHAFTClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *SHAFTClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *SHAFTClient) EstimateGas(ctx *Context, msg *CallMsg) (gas *BigInt, _ error) {
...
func (ec *SHAFTClient) SendTransaction(ctx *Context, tx *Transaction) error {

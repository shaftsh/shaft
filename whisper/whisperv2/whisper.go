...
import (
	...
	"github.com/shaft/go-shaft/crypto/ecies"
	"github.com/shaft/go-shaft/event/filter"
...
// Whisper represents a dark communication interface through the SHAFT
...
// New creates a Whisper client ready to communicate through the SHAFT P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),

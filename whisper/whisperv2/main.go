...
import (
	...
	"github.com/shaft/go-shaft/logger"
	"github.com/shaft/go-shaft/p2p"
	"github.com/shaft/go-shaft/p2p/nat"
	"github.com/shaft/go-shaft/whisper"
)
...
func main() {
	...
	// Create an SHAFT peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting SHAFT peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start SHAFT peer: %v.\n", err)
		os.Exit(1)
	}

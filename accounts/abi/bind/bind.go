...
// Package bind generates SHAFT contract Go bindings.
//
// Detailed usage document and tutorial available on the go-shaft Wiki page:
// https://github.com/shaft/go-shaft/wiki/Native-DApps:-Go-bindings-to-SHAFT-contracts
package bind

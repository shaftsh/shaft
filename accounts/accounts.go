...
// Package accounts implements high level SHAFT account management.
package accounts
...
// Account represents an SHAFT account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // SHAFT account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain shaft.ChainStateReader)

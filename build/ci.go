...
import (
	...
	"github.com/shaft/go-shaft/internal/build"
)
...
var (
	...
	debExecutables = []debExecutable{
		{
			Name:        "abigen",
			Description: "Source code generator to convert SHAFT contract definitions into easy to use, compile-time type-safe Go packages.",
		},
		{
			Name:        "bootnode",
			Description: "SHAFT bootnode.",
		},
		{
			Name:        "evm",
			Description: "Developer utility version of the EVM (SHAFT Virtual Machine) that is capable of running bytecode snippets within a configurable environment and execution mode.",
		},
		{
			Name:        "geth",
			Description: "SHAFT CLI client.",
		},
		{
			Name:        "puppeth",
			Description: "SHAFT private network manager.",
		},
		{
			Name:        "rlpdump",
		...
		{
			Name:        "swarm",
			Description: "SHAFT Swarm daemon and tools",
		},
		{
			Name:        "wnode",
			Description: "SHAFT Whisper diagnostic tool",
		},
	}
...
func doInstall(cmdline []string) {
	...
	if runtime.Version() < "go1.7" && !strings.Contains(runtime.Version(), "devel") {
		...
		log.Println("go-shaft requires at least Go version 1.7 and cannot")
...
func doDebianSource(cmdline []string) {
	var (
		...
		upload  = flag.String("upload", "", `Where to upload the source package (usually "ppa:shaft/shaft")`)
...
type debMetadata struct {
	...
	// go-shaft version being built. Note that this
...
func newDebMetadata(distro, author string, env build.Environment, t time.Time) debMetadata {
	if author == "" {
		...
		author = "SHAFT Builds <fjl@shaft.org>"
	}
	return debMetadata{
		Env:         env,
		Author:      author,
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.shaft", "-v", "github.com/shaft/go-shaft/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/shaft/go-shaft/mobile")

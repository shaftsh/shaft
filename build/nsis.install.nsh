...
!define HELPURL "https://github.com/shaft/go-shaft/issues"
!define UPDATEURL "https://github.com/shaft/go-shaft/releases"
!define ABOUTURL "https://github.com/shaft/go-shaft#shaft-go"
...
Section "Geth" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "SHAFT" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "SHAFT" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "SHAFT" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/shaft/EIPs/issues/147)
